<div align="center">
  ...
  <h1><a href="https://codeforces.com/problemset/problem/2234/B" target="_blank">2234B - B. Palindrome, Twelve and Two Terms</a></h1>

  <p>time limit per test: 1.5 seconds<br>
  memory limit per test: 256 megabytes</p>
  <p><strong>tags:</strong> <code>brute force, constructive algorithms, math</code> | <strong>rating:</strong> <code>800</code></p>
</div>
