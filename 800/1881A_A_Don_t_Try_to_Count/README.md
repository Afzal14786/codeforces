<div align="center">
  ...
  <h1><a href="https://codeforces.com/problemset/problem/1881/A" target="_blank">1881A - A. Don't Try to Count</a></h1>

  <p>time limit per test: 2.0 seconds<br>
  memory limit per test: 256 megabytes</p>
  <p><strong>tags:</strong> <code>brute force, strings</code> | <strong>rating:</strong> <code>800</code></p>
</div>
