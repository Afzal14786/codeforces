<div align="center">
  ...
  <h1><a href="https://codeforces.com/problemset/problem/1789/A" target="_blank">1789A - A. Serval and Mocha's Array</a></h1>

  <p>time limit per test: 1.0 seconds<br>
  memory limit per test: 256 megabytes</p>
  <p><strong>tags:</strong> <code>brute force, math, number theory</code> | <strong>rating:</strong> <code>800</code></p>
</div>
