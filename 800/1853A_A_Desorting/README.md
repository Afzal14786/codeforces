<div align="center">
  ...
  <h1><a href="https://codeforces.com/problemset/problem/1853/A" target="_blank">1853A - A. Desorting</a></h1>

  <p>time limit per test: 1.0 seconds<br>
  memory limit per test: 256 megabytes</p>
  <p><strong>tags:</strong> <code>brute force, greedy, math</code> | <strong>rating:</strong> <code>800</code></p>
</div>
