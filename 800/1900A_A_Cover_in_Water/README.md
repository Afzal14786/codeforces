<div align="center">
  ...
  <h1><a href="https://codeforces.com/problemset/problem/1900/A" target="_blank">1900A - A. Cover in Water</a></h1>

  <p>time limit per test: 1.0 seconds<br>
  memory limit per test: 256 megabytes</p>
  <p><strong>tags:</strong> <code>constructive algorithms, greedy, implementation, strings</code> | <strong>rating:</strong> <code>800</code></p>
</div>
