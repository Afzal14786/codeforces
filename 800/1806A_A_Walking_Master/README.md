<div align="center">
  ...
  <h1><a href="https://codeforces.com/problemset/problem/1806/A" target="_blank">1806A - A. Walking Master</a></h1>

  <p>time limit per test: 1.0 seconds<br>
  memory limit per test: 1024 megabytes</p>
  <p><strong>tags:</strong> <code>geometry, greedy, math</code> | <strong>rating:</strong> <code>800</code></p>
</div>
