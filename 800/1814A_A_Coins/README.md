<div align="center">
  ...
  <h1><a href="https://codeforces.com/problemset/problem/1814/A" target="_blank">1814A - A. Coins</a></h1>

  <p>time limit per test: 2.0 seconds<br>
  memory limit per test: 256 megabytes</p>
  <p><strong>tags:</strong> <code>implementation, math</code> | <strong>rating:</strong> <code>800</code></p>
</div>
